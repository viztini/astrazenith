...
AstraZenith reimplements the same core loop in ~10K lines of readable Python, allowing acess to any model you want, open-source, keeping everything you need and dropping what you don't.
