"""System context: project instructions (CLAUDE.md), git info, cwd injection."""
import os
import subprocess
...
You are AstraZenith, an AI coding assistant running in the terminal.
...
## Plugins
Plugins extend AstraZenith with additional tools, skills, and MCP servers.
...
def get_project_md() -> str:
    """Load CLAUDE.md from cwd or parents and ~/.claude/CLAUDE.md (Claude Code–style paths)."""
    content_parts = []

    # Global instructions (same path as Claude Code)
