...
def _list_agent_types(params: dict, config: dict) -> str:
    ...
    lines.append("")
    lines.append(
        "Create custom agents: place .md files in ~/.astra_zenith/agents/ or .astra_zenith/agents/"
    )
    return "\n".join(lines)
...
register_tool(ToolDef(
    ...
    schema={
        ...
        "description": (
            ...
            "types (coder, reviewer, researcher, tester, or custom from .astra_zenith/agents/), "
