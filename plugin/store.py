...
USER_PLUGIN_DIR  = Path.home() / ".astra_zenith" / "plugins"
USER_PLUGIN_CFG  = Path.home() / ".astra_zenith" / "plugins.json"

def _project_plugin_dir() -> Path:
    return Path.cwd() / ".astra_zenith" / "plugins"

def _project_plugin_cfg() -> Path:
    return Path.cwd() / ".astra_zenith" / "plugins.json"
