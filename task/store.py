"""Thread-safe task store: in-memory dict persisted to .astra_zenith/tasks.json."""
...
# Tasks are keyed by ID, stored per session in <cwd>/.astra_zenith/tasks.json
...
def _tasks_file() -> Path:
    return Path.cwd() / ".astra_zenith" / "tasks.json"
