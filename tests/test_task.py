...
def isolated_store(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(_store, "_tasks_file", lambda: tmp_path / ".astra_zenith" / "tasks.json")
    yield
    _store._tasks.clear()
...
class TestTaskToolFunctions:
    ...
    def test_tool_schemas_in_tool_schemas_list(self):
        """Task tool schemas are also present in TOOL_SCHEMAS for the model's tool list."""
